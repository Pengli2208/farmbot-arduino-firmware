...
ARDUINO_FW=$(OUT_DIR)/arduino-firmware.hex
FARMDUINO_FW=$(OUT_DIR)/farmduino-firmware.hex
FARMDUINO_V14_FW=$(OUT_DIR)/farmduino_k14-firmware.hex
BLINK_FW=$(OUT_DIR)/blink.hex
CLEAR_EEPROM_FW=$(OUT_DIR)/clear_eeprom.hex
...
ARDUINO_BUILD_DIR := $(OUT_DIR)/arduino
ARDUINO_CACHE_DIR := $(OUT_DIR)/arduino-cache
...
SRC=$(wildcard src/*.cpp) $(wildcard src/*.h) $(wildcard src/*.ino)
